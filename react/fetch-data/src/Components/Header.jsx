    ...
    return (
        <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
            <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
                <div id="collapseMenu"
                    className='max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50 lg:mx-auto'>
                    ...
                    <ul
                        ...
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><NavLink to='/users'
                            className={({isActive}) => isActive ? 'hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]': 'hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'}>Users</NavLink>
                        </li>
                    </ul>
                </div>
