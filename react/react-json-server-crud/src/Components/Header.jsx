        ...
        <header className='flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
            <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
                ...
                <div id="collapseMenu"
                    ...
                    <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border' onClick={() => handleClick()}>
                    ...
                    <ul
                        ...
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                            <NavLink to='/add-post'
                                className={({ isActive }) => isActive ? "hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]" : "hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"}>Add Post</NavLink>
                        </li>
